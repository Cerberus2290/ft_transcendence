...
urlpatterns = [
    ...
    path('disable-2fa/', views.DisableTwoFactorAPIView.as_view(), name='disable_2fa'),
    path('2fa-status/', views.TwoFactorCheck, name='2fa_status'),
    ...
    path('tournaments/<int:tournament_id>/update-finished/', views.update_tournament_finished, name='update-tournament-finished'),
